...
class RegistrationTest < ActiveSupport::TestCase
  ...
  context "Within context" do
    ...
    should "have an alphabetical scope" do
      assert_equal ["Stuttgen, Nikki", "Stuttgen, Peter", "Stuttgen, Peter", "Trott, Michael", "Trott, James"], Registration.alphabetical.all.map{|r| r.student.name}
    end

    should "have an for_camp scope" do
      assert_equal [@peter_tactics, @amer_tactics], Registration.for_camp(@camp1).sort_by{|r| r.student.last_name}
    end
    ...
    should "verify that the student has a rating appropriate for the camp" do
      ...
      # verify that Michael (rating 535) cannot register for endgames (700-1500)
    ...
    #     @amer_tactics.credit_card_number = num
    #     assert_equal name, @amer_tactics.credit_card_type, "#{@amer_tactics.credit_card_type} :: #{@amer_tactics.credit_card_number}"
    #   end
    # end
    ...
    #   @amer_tactics.credit_card_number = 9123456789012345
    #   @amer_tactics.expiration_month = Date.current.month + 1
    #   @amer_tactics.expiration_year = Date.current.year
    #   deny @amer_tactics.valid?
    ...
    #     @amer_tactics.credit_card_number = num
    #     assert @amer_tactics.valid?, "#{@amer_tactics.credit_card_number}"
    #   end
    ...
    #     @amer_tactics.credit_card_number = num
    #     deny @amer_tactics.valid?, "#{@amer_tactics.credit_card_number}"
    #   end
    # end  
    ...
    #   assert @amer_tactics.valid?
    #   @amer_tactics.credit_card_number = "4123456789012"
    #   @amer_tactics.expiration_month = Date.current.month
    #   @amer_tactics.expiration_year = 1.year.ago.year
    #   deny @amer_tactics.valid?
    #   @amer_tactics.expiration_year = Date.current.year
    #   assert @amer_tactics.valid?
    #   @amer_tactics.expiration_month = Date.current.month - 1
    ...
    #   @amer_tactics.payment = nil
    #   assert @amer_tactics.save
    #   @amer_tactics.credit_card_number = "4123456789012"
    #   @amer_tactics.expiration_month = Date.current.month + 1
    #   @amer_tactics.expiration_year = Date.current.year
    #   assert @amer_tactics.valid?
    ...
    #   @amer_tactics.pay
    #   assert_equal "camp: #{@amer_tactics.camp_id}; student: #{@amer_tactics.student_id}; amount_paid: #{@amer_tactics.camp.cost}; card: #{@amer_tactics.credit_card_type} ****#{@amer_tactics.credit_card_number[-4..-1]}", Base64.decode64(@amer_tactics.payment)
    #   @amer_tactics.reload
    #   # now verify that you can't pay twice
    #   assert_not_nil @amer_tactics.payment
    #   deny @amer_tactics.pay
    # end
